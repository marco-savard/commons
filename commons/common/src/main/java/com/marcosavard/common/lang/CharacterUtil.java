...
import com.marcosavard.common.lang.safe.SafeArrayList;
...
public class CharacterUtil {
  ...
  public static Map<Character, List<Character>> getDiacriticals(Locale locale) {
    ...
    for (int i = 0; i < 256; i++) {
      ...
      if (Character.isLowerCase(ch) && CharacterUtil.isDiacritical(ch, locale)) {
        char letter = CharacterUtil.stripAccent(ch);
        Diacritical diacritical = CharacterUtil.getDiacritical(ch);
