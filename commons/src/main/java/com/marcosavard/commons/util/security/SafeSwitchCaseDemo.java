...
public class SafeSwitchCaseDemo {
    ...
    public static void main(String[] args) {
        ...
        AddressProcessor[] addressProcessors = new AddressProcessor[] {
    ...
    // inner classes
    //
    private static abstract class AddressProcessor {
    ...
    private static class SafeAddressProcessor extends AddressProcessor {
        ...
        public void processAddress(Processor[] processors, String address) {
            ...
            Runnable switchCase = SafeSwitchCase.switchOn(value)
