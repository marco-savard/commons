 ...
 * When a task begins, a beginTask(String, int) notification is reported, followed by any number and
 * mixture of progress reports (worked()) and subtask notifications (subTask(String)). When the task
 * is eventually completed, a done() notification is reported. After the done() notification, the
 * progress monitor cannot be reused; i.e., beginTask(String, int) cannot be called again after the
 * call to done().
 * 
