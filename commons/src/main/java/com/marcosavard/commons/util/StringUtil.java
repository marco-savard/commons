...
public class StringUtil {
  ...
  public static String capitalize(String original) {
    ...
    capitalized = (capitalized.length() == 0) ? capitalized
        : capitalized.substring(0, 1).toUpperCase() + capitalized.substring(1);
    return capitalized;
  }
  ...
  public static String padLeft(String source, int totalLength) {
    String padded = String.format("%1$" + totalLength + "s", source);
    return padded;
  }
  ...
  public static String trimDoubleBlanks(String original) {
    String trimmed = original.replace(" +", " ");
    return trimmed;
  }
