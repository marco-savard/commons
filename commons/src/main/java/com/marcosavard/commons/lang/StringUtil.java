...
public class StringUtil {
    ...
    public static int compareToIgnoreCaseAccent(CharSequence original, CharSequence other, Locale locale) {
		return stripAccents(toLowerCase(original, locale)).compareToIgnoreCase(stripAccents(toLowerCase(other, locale)));
    }
