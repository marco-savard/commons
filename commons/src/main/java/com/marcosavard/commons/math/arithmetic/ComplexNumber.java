...
/**
 * Credits : https://introcs.cs.princeton.edu/java/32class/Complex.java.html TODO x + yj notation
...
public class ComplexNumber extends Number {
  ...
  public ComplexNumber multiplyBy(ComplexNumber other) {
    double r =
        (real.doubleValue() * other.real.doubleValue())
            - (imaginary.doubleValue() * other.imaginary.doubleValue());
    double i =
        (real.doubleValue() * other.imaginary.doubleValue())
            + (imaginary.doubleValue() * other.real.doubleValue());
  ...
  public static class ComplexNumberFormat extends DecimalFormat {
    public static final ComplexNumberFormat DEFAULT_LOCALE_FORMAT =
        new ComplexNumberFormat(Locale.getDefault(), "i");
    ...
    public static ComplexNumberFormat ofFormat(String imaginaryPart) {
      ComplexNumberFormat numberFormat =
          new ComplexNumberFormat(Locale.getDefault(), imaginaryPart);
      return numberFormat;
    }
