...
public class JulianDayDemo {
  ...
  public static void main(String[] args) {
    testJulianDay(1968, 5, 23, 2440000);
    testJulianDay(1969, 7, 21, 2440424);
    testJulianDay(1980, 1, 1, 2444240);
    testJulianDay(1982, 1, 1, 2444971);
    testJulianDay(2000, 1, 1, 2451545);
