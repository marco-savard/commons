...
public class SpaceLocationFinderDemo {
  ...
  private static void findStarInCentralScandinavia() {
    ...
    //  SpaceCoordinate location = SpaceLocationFinder.find(position, scandinavia.toCoordinates(),
    // moment);
  ...
  private static void findStarAtAjaccio() {
    ...
    // SpaceCoordinate location = SpaceLocationFinder.find(position, ajaccio.toCoordinates(),
    // moment);
    // System.out.println(location);
