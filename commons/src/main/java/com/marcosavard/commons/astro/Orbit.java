...
public class Orbit {
  public static final Orbit SUN_APPARENT_ORBIT =
  ...
  public static Orbit of(
      double distance, LengthUnit lengthUnit, double period, ChronoUnit chronoUnit) {
  ...
  public Orbit withLongitudeOfPerihelion(
      double longitudeOfPerihelion, double longitudeOfPerihelionVariation) {
  ...
  public Orbit withObliquityOfEcliptic(
      double obliquityOfEcliptic, double obliquityOfEclipticVariation) {
