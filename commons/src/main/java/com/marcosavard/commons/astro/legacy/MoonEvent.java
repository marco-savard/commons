 ...
 * 01.06.96
 *
 * <p>Java class to calculate the phase of the moon, given a date. The 'moonPhase' method is a Java
 ...
 *
 * <p>To use this in a program, create an object of class 'MoonCalculation'.
 *
 * <p>I'm not convinced that the algorithm is entirely accurate, but I don't know enough to confirm
 * whether it is or not.
 *
 * <p>HISTORY -------
 *
 * <p>31.05.96 SLAM Converted from C 01.06.96 SLAM Added 'phaseName' to return the name of a phase.
 * Fixed leap year test in 'daysInMonth'.
 *
 * <p>LEGAL -----
 *
 * <p>This software is free. It can be used and modified in any way you choose. The author assumes
 * no liability for any loss or damage you may incur through use of or inability to use this
 * software. This disclaimer must appear on any modified or unmodified version of the software in
 * which the name of the author also appears.
 *
 * <p>based on:
