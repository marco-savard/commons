...
/**
 * A class to store a North American phone number, with formatting 
...
public class PhoneNumber implements Serializable {	
	public enum Format {BLANK_AND_DASH}; 
	...
	/**
	 * Get a probable area code for a given postal code. Useful 
	 * for error detection or to create realistic test cases. 
	 * 
