...
public enum Continent {
    ...
    private String getDisplayAfrica(Locale displayLanguage) {
        ...
        if (Arrays.asList("cs", "hr", "sr", "hu").contains(displayLanguage.getLanguage())) {
            displayName = "Afrika";
        } else {
    ...
    private String getDisplayAmerica(Locale displayLanguage) {
        ...
        if (Arrays.asList("hr", "sr").contains(displayLanguage.getLanguage())) {
            ...
            Locale latinAmerica = allLocales.stream().filter(l -> l.toString().equals("es_419")).findFirst().orElse(null);
    ...
    public String getDisplayAsia(Locale displayLanguage) {
        ...
        if (Arrays.asList("nl").contains(displayLanguage.getLanguage())) {
            displayName = "Azië";
        } else if (Arrays.asList("sq").contains(displayLanguage.getLanguage())) {
            displayName = "Azia";
        } else {
    ...
    private String getDisplayAustralia(Locale displayLanguage) {
        ...
        Locale australia = locales.stream().filter(l -> l.toString().equals("en_AU")).findFirst().orElse(null);
    ...
    private String getDisplayEurope(Locale displayLanguage) {
        List<Locale> locales = Arrays.asList(Locale.getAvailableLocales());
        Locale europe = locales.stream().filter(l -> l.toString().equals("en_150")).findFirst().orElse(null);
    ...
    private String getSouthAfrica(Locale displayLanguage) {
        List<Locale> locales = Arrays.asList(Locale.getAvailableLocales());
        Locale locale = locales.stream().filter(l -> l.toString().equals("en_ZA")).findFirst().orElse(null);
        return locale.getDisplayCountry(displayLanguage);
    }

    private String getSouthKorea(Locale displayLanguage) {
        List<Locale> locales = Arrays.asList(Locale.getAvailableLocales());
        Locale locale = locales.stream().filter(l -> l.toString().equals("ko_KR")).findFirst().orElse(null);
        return locale.getDisplayCountry(displayLanguage);
    }
