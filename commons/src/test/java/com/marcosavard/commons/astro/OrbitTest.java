...
public class OrbitTest {
    ...
    public void givenEarthOrbitAroundSun_whenDistanceIsOneAstroUnit_thenPeriodIsOneYear() {
        ...
        System.out.println("  Mean distance of Earth in AU: " + orbit.getMeanDistanceFromCenter(LengthUnit.ASTRONOMICAL_UNIT));
        System.out.println("  Mean distance of Earth in millions of km: " + orbit.getMeanDistanceFromCenter(LengthUnit.GM));
        System.out.println("  Minimal distance of Earth in MKm: " + orbit.getDistanceAtPeriaxis(LengthUnit.GM));
        System.out.println("  Maximal distance of Earth in MKm: " + orbit.getDistanceAtApoaxis(LengthUnit.GM));
        System.out.println();
    }
    ...
    public void givenMarsOrbitAroundSun_whenDistanceIsOneAstroUnit_thenPeriodIsOneYear() {
        ...
        System.out.println("  Minimal distance of Mars in millions of km: " + orbit.getDistanceAtPeriaxis(LengthUnit.ASTRONOMICAL_UNIT));
        ...
        System.out.println("  Minimal distance of Mars in millions of km: " + sunOrbit.getDistanceAtPerihelion(LengthUnit.ASTRONOMICAL_UNIT));
        System.out.println("  Maximal distance of Mars in millions of km: " + sunOrbit.getDistanceAtAphelion(LengthUnit.ASTRONOMICAL_UNIT));
        System.out.println();
    }
