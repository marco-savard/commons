...
public class Language {
  ...
  public static final Language AFRIKANER = Language.ofCode("af");

  public static final Language ALBANIAN = Language.ofCode("sq");

  public static final Language AZERBAIJANI = Language.ofCode("az");
  public static final Language CROATIAN = Language.ofCode("hr");

  public static final Language CZECK = Language.ofCode("cs");
  public static final Language DANISH = Language.ofCode("da");
  public static final Language DUTCH = Language.ofCode("nl");
  public static final Language ENGLISH = Language.ofCode(Locale.ENGLISH.getLanguage());
  public static final Language ESPERANTO = Language.ofCode("eo");
  public static final Language FRENCH = Language.ofCode(Locale.FRENCH.getLanguage());
  public static final Language GERMAN = Language.ofCode(Locale.GERMAN.getLanguage());
  public static final Language FINNISH = Language.ofCode("fi");
  public static final Language HUNGARIAN = Language.ofCode("hu");
  public static final Language ITALIAN = Language.ofCode(Locale.ITALIAN.getLanguage());

  public static final Language ICELANDIC = Language.ofCode("is");

  public static final Language LATIN = Language.ofCode("la");

  public static final Language NORVEGIAN = Language.ofCode("no");

  public static final Language POLISH = Language.ofCode("pl");

  public static final Language PORTUGUESE = Language.ofCode("pt");
  public static final Language ROMANIAN = Language.ofCode("ro");

  public static final Language SLOVAK = Language.ofCode("sk");

  public static final Language SLOVENIAN = Language.ofCode("sl");
  public static final Language SPANISH = Language.ofCode("es");
  public static final Language SWEDISH = Language.ofCode("sv");

  public static final Language TURKISH = Language.ofCode("tr");
  ...
  private static String[][] LANGUAGE_TO_COUNTRY_MAP =
      new String[][] {
        new String[] {"cs", "CZ"},
        new String[] {"da", "DK"},
        new String[] {"en", "GB"},
  ...
  public static Language[] ofScript(Character.UnicodeScript script) {
    ...
    Language[] languages =
        (languageList == null) ? new Language[] {} : languageList.toArray(new Language[0]);
    return languages;
  }
  ...
  public boolean isAmericanLanguage() {
    List<String> americanCountries =
        Arrays.asList(new String[] {"BO", "BR", "CA", "GL", "HT", "PE", "PY", "US"});
    Locale countryLocale =
        countryLocales.stream()
  ...
  public boolean isEuropeanLanguage() {
    ...
    List<String> europeanCountry =
        Arrays.asList(
            new String[] {
              "AL", "BA", "CH", "CZ", "DK", "GB", "HR", "HU", "IM", "IS", "MD", "NO", "PL", "RO",
              "RU"
            });
    ...
    Locale countryLocale =
        countryLocales.stream()
            ...
            .filter(
                l ->
                    !invalidCountries.contains(l.getCountry())
                        && (euro.equals(Currency.getInstance(l))
                            || europeanCountry.contains(l.getCountry())))
            .findFirst()
            .orElse(null);
    return (countryLocale != null);
  }
  ...
  public boolean isWestEuropeanLanguage() {
    List<String> westEuropeCountries =
        Arrays.asList(new String[] {"BE", "FR", "GB", "IR", "LU", "NL"});
    Locale countryLocale =
        countryLocales.stream()
  ...
  public boolean isCentralEuropeanLanguage() {
    List<String> centralEuropeCountries =
        Arrays.asList(
            new String[] {"AT", "CH", "CZ", "DE", "ET", "HR", "HU", "LT", "LV", "PL", "SK", "SL"});
    Locale countryLocale =
        countryLocales.stream()
            .filter(
                l -> !l.getCountry().isEmpty() && centralEuropeCountries.contains(l.getCountry()))
            .findFirst()
            .orElse(null);
    return (countryLocale != null);
  }
  ...
  public boolean isWesternRomanceLanguage() {
    List<String> romanceLanguages =
        Arrays.asList(new String[] {"an", "ca", "es", "fr", "gl", "oc", "pt", "rm", "wa"});
  ...
  public boolean isScandinavianLanguage() {
    List<String> scandinavianLanguages =
        Arrays.asList(new String[] {"da", "fo", "is", "nb", "nn", "no", "sv"});
    return scandinavianLanguages.contains(languageLocale.getLanguage());
  }

  public boolean isWestGermanicLanguage() {
    List<String> scandinavianLanguages =
        Arrays.asList(new String[] {"de", "en", "fy", "lb", "li", "nl"});
    return scandinavianLanguages.contains(languageLocale.getLanguage());
  }
  ...
  public boolean isOceanianLanguage() {
    List<String> oceanianCountries =
        Arrays.asList(new String[] {"FJ", "GU", "MH", "NR", "NZ", "PF", "PG", "TO", "VU", "WS"});
    Locale countryLocale =
        countryLocales.stream()
  ...
  public boolean isCentralAsiaLanguage() {
    List<String> centralAsiaCountries =
        Arrays.asList(new String[] {"AZ", "GE", "IR", "TM", "TR", "UZ"});
    Locale countryLocale =
        countryLocales.stream()
  ...
  public boolean isCentralAfricaLanguage() {
    List<String> centralAfricaCountries =
        Arrays.asList(new String[] {"BI", "CD", "CF", "RW", "UG"});
    Locale countryLocale =
        countryLocales.stream()
            .filter(
                l -> !l.getCountry().isEmpty() && centralAfricaCountries.contains(l.getCountry()))
            .findFirst()
            .orElse(null);
    return (countryLocale != null);
  }
