...
import com.marcosavard.common.math.SafeMath;
...
public class GeoLocation implements Serializable {
  ...
  public static GeoLocation findClosest(List<GeoLocation> locations, GeoLocation location) {
    GeoLocation closest = null;
    double lowestDistance = Double.MAX_VALUE;

    for (GeoLocation eachLocation : locations) {
      double distance = location.findDistanceFrom(eachLocation);

      if (distance < lowestDistance) {
        lowestDistance = distance;
        closest = eachLocation;
      }
    }
